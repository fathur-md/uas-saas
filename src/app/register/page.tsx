        ...
        <div className="w-full max-w-md">
          ...
          <form className="space-y-5" action={action}>
            ...
            <div>
              ...
              <input name="password" type="password" required autoComplete="new-password" className="mt-1 block w-full rounded-xl border-0 py-3 px-4 text-primary ring-1 ring-inset ring-neutral-light/50 bg-background/50 focus:ring-2 focus:ring-accent transition-all sm:text-sm" />
            </div>
