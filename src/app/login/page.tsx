    ...
    <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
      ...
      <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        ...
        <p className="mt-10 text-center text-sm text-gray-500">
          Belum punya akun?{" "}
          <Link href="/register" className="font-semibold leading-6 text-gray-900 hover:underline">
            Daftar Customer
          </Link>
          {" "}atau{" "}
          <Link href="/register/merchant" className="font-semibold leading-6 text-gray-900 hover:underline">
            Daftar Merchant
          </Link>
        </p>
      </div>
